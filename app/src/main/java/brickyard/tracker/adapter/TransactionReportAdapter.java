...
public class TransactionReportAdapter extends BaseAdapter {
    ...
    public TransactionReportAdapter(Context mContext, List<RecordBean> dataList, String currencySymbol) {
        context = mContext;
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        try {
            final TransactionReportAdapter.ViewHolder holder;
            if (view == null) {
                holder = new TransactionReportAdapter.ViewHolder();
                view = inflater.inflate(R.layout.transaction_search_report_datalist, null);
                ...
                holder = (TransactionReportAdapter.ViewHolder) view.getTag();
            }
