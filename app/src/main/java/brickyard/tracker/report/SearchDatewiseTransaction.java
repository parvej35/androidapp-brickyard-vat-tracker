...
public class SearchDatewiseTransaction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try {
            ...
            setContentView(R.layout.transaction_search_datewise);
                ...
                public void onClick(View v) {
                    try {
                        ...
                        if(longDate2 < longDate1) {
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SearchDatewiseTransaction.this);
                        ...
                        if(date_range > Constant.MAX_DATE_RANGE_IN_DAYS) {
                            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SearchDatewiseTransaction.this);
                                alertDialogBuilder.setMessage("Selected date range should not be more than "+Constant.MAX_DATE_RANGE_IN_DAYS+ " days")
                                .setPositiveButton("Close", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {
                                        dialog.cancel();
                        ...
                        Intent intent = new Intent(getApplicationContext(), DatewiseTransactionList.class);
                        intent.putExtra("strFromDate", strFromDate);
                        intent.putExtra("strToDate", strToDate);
                        intent.putExtra("type", type);
                        intent.putExtra("sector", sector);
                        intent.putExtra("fromDate", String.valueOf(longDate1));
                        intent.putExtra("toDate", String.valueOf(longDate2));
    ...
    private void showFromDatePicker() {
        ...
        datePickerDialog = new DatePickerDialog(SearchDatewiseTransaction.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    private void showTypeList() {
        try {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(SearchDatewiseTransaction.this);
